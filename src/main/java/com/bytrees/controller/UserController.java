...
public class UserController {
	...
	public ResponseEntity<ResponseJson<Object>> login(HttpServletRequest request, HttpServletResponse response, HttpSession session) {
	...
	public ResponseEntity<ResponseJson<Object>> register(@RequestBody UserVO userVO) {
		User user = new User();
